...
local SJaD = io.open("SJaD", 'w')
SJaD:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 SJaD.lua
done
]])
SJaD:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S SJaD -X kill
screen -S SJaD ./SJaD
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x SJaD;chmod +x Run;./Run')
end
...
SJaD = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..SJaD)
LuaTele = luatele.set_config{api_id=10219117,api_hash='13d45619687411928ad2d0a5b747627e',session_name=SJaD,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,5296323872}  
...
Status = 0
DevelopersQ = Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",UserId) 
if UserId == 5296323872 then
Status = true
elseif UserId == 5296323872 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == SJaD then
Status = true
...
Status = 0
Developers = Redis:sismember(SJaD.."SJaD:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",UserId) 
TheMaleks = Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..ChatId,UserId) 
TheBasics = Redis:sismember(SJaD.."SJaD:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(SJaD.."SJaD:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(SJaD.."SJaD:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(SJaD.."SJaD:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(SJaD.."SJaD:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(SJaD.."SJaD:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheMaleks then
Status = Redis:get(SJaD.."SJaD:Posss:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(SJaD.."SJaD:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(SJaD.."SJaD:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(SJaD.."SJaD:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(SJaD.."SJaD:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(SJaD.."SJaD:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(SJaD.."SJaD:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(SJaD.."SJaD:lockpin"..ChatId) then    
lock_pin = "✓"
else 
lock_pin = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:tagservr"..ChatId) then    
lock_tagservr = "✓"
else 
lock_tagservr = "✗"
end
if Redis:get(SJaD.."SJaD:Lock:text"..ChatId) then    
lock_text = "✓"
else 
lock_text = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✓"
else 
lock_add = "✗"    
end    
if Redis:get(SJaD.."SJaD:Lock:Join"..ChatId) == "kick" then
lock_join = "✓"
else 
lock_join = "✗"    
end    
if Redis:get(SJaD.."SJaD:Lock:edit"..ChatId) then    
lock_edit = "✓"
else 
lock_edit = "✗"    
end
if Redis:get(SJaD.."SJaD:Chek:Welcome"..ChatId) then
welcome = "✓"
else 
welcome = "✗"    
end
if Redis:hget(SJaD.."SJaD:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(SJaD.."SJaD:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(SJaD.."SJaD:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(SJaD.."SJaD:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✓"
else     
flood = "✗"     
end
if Redis:get(SJaD.."SJaD:Lock:Photo"..ChatId) == "del" then
lock_photo = "✓" 
elseif Redis:get(SJaD.."SJaD:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(SJaD.."SJaD:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "✓"   
end    
if Redis:get(SJaD.."SJaD:Lock:Contact"..ChatId) == "del" then
lock_phon = "✓" 
elseif Redis:get(SJaD.."SJaD:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "✗"    
end    
if Redis:get(SJaD.."SJaD:Lock:Link"..ChatId) == "del" then
lock_links = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(SJaD.."SJaD:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:User:Name"..ChatId) == "del" then
lock_user = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:vico"..ChatId) == "del" then
lock_muse = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "✗"    
end 
if Redis:get(SJaD.."SJaD:Lock:Video"..ChatId) == "del" then
lock_ved = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:Animation"..ChatId) == "del" then
lock_gif = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:geam"..ChatId) == "del" then
lock_geam = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "✗"    
end    
...
if Redis:get(SJaD.."SJaD:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(SJaD.."SJaD:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "✗"
end
if Redis:get(SJaD.."SJaD:Lock:forward"..ChatId) == "del" then
lock_fwd = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "✗"    
end    
if Redis:get(SJaD.."SJaD:Lock:Document"..ChatId) == "del" then
lock_file = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "✗"    
end    
if Redis:get(SJaD.."SJaD:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(SJaD.."SJaD:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "✗"    
end
if Redis:get(SJaD.."SJaD:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✓"
elseif Redis:get(SJaD.."SJaD:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(SJaD.."SJaD:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(SJaD.."SJaD:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "✗"    
end        
...
return{
BanAll = Redis:sismember(SJaD.."SJaD:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(SJaD.."SJaD:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(SJaD.."SJaD:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[ ‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 › ](https://t.me/TI9TI9)\n*— — — — — — — — —\n⤈︙بواسطه ↫ *'..UserInfousername..'\n*'..TextMsg..'\n⤈︙خاصيه المسح *',
unLock   = '[ ‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 › ](https://t.me/TI9TI9)\n*— — — — — — — — —\n⤈︙بواسطه ↫ *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[ ‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 › ](https://t.me/TI9TI9)\n*— — — — — — — — —\n⤈︙بواسطه ↫ *'..UserInfousername..'\n*'..TextMsg..'\n⤈︙خاصيه الكتم *',
lockKid  = '[ ‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 › ](https://t.me/TI9TI9)\n*— — — — — — — — —\n⤈︙بواسطه ↫ *'..UserInfousername..'\n*'..TextMsg..'\n⤈︙خاصيه التقييد *',
lockKick = '[ ‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 › ](https://t.me/TI9TI9)\n*— — — — — — — — —\n⤈︙بواسطه ↫ *'..UserInfousername..'\n*'..TextMsg..'\n⤈︙خاصيه الطرد *',
Reply    = '[ ‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 › ](https://t.me/TI9TI9)\n*— — — — — — — — —\n⤈︙المستخدم ↫ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,SJaD).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(SJaD..'SJaD:Channel:Join')
if Channel then
if The_ControllerAll(msg.sender.user_id) == false then
...
if tonumber(msg.sender.user_id) == tonumber(SJaD) then
...
if tonumber(msg.sender.user_id) == 5296323872 then
msg.Name_Controller = 'مبرمج السورس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5296323872 then
...
elseif Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الاساسي ²'
elseif Redis:sismember(SJaD.."SJaD:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(SJaD.."SJaD:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(SJaD.."SJaD:Posss:Group:Reply"..msg.chat_id) or 'المالك '
elseif Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(SJaD.."SJaD:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي '
elseif Redis:sismember(SJaD.."SJaD:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(SJaD.."SJaD:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(SJaD.."SJaD:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(SJaD.."SJaD:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(SJaD.."SJaD:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(SJaD.."SJaD:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(SJaD) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(SJaD.."SJaD:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(SJaD.."SJaD:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(SJaD.."SJaD:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(SJaD.."SJaD:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
local phshar_Group = Redis:get(SJaD.."SJaD:Lock:phshar"..msg_chat_id)
if phshar_Group then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
-- if (Redis:get(SJaD..'SJaD:Lock:Channel') == 'true') then
-- if msg.sender.luatele == "messageSenderChat" then
-- LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
-- else 
-- print("gg")
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(SJaD.."SJaD:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(SJaD) then return false end
--
local floods = Redis:hget(SJaD.."SJaD:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil" local Num_Msg_Max = Redis:hget(SJaD.."SJaD:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5 local post_count = tonumber(Redis:get(SJaD.."SJaD:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(SJaD.."SJaD:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(SJaD.."SJaD:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⤈︙قام بالتكرار في المجموعه وتم طرده").Reply,"md",true) end
if type == "del" then  return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) end
if type == "keed" then return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0}), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⤈︙قام بالتكرار في المجموعه وتم تقيده").Reply,"md",true)   end
if type == "mute" then Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg.chat_id,msg.sender.user_id)  return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⤈︙قام بالتكرار في المجموعه وتم كتمه").Reply,"md",true)   end end Redis:setex(SJaD.."SJaD:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1)  local edit_id = data.text_ or "nil"  Num_Msg_Max = 5
if Redis:hget(SJaD.."SJaD:Spam:Group:User"..msg_chat_id,"Num:Spam") then Num_Msg_Max = Redis:hget(SJaD.."SJaD:Spam:Group:User"..msg_chat_id,"Num:Spam")  end end 
--
if text and not msg.Distinguished then local _nl, ctrl_ = string.gsub(text, "%c", "")  local _nl, real_ = string.gsub(text, "%d", "")  sens = 400  
if Redis:get(SJaD.."SJaD:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) elseif Redis:get(SJaD.."SJaD:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) elseif Redis:get(SJaD.."SJaD:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) elseif Redis:get(SJaD.."SJaD:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg.chat_id,msg.sender.user_id)  LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) end end
--
if msg.forward_info and not msg.Addictive then -- التوجيه
local Fwd_Group = Redis:get(SJaD.."SJaD:Lock:forward"..msg_chat_id)
if Fwd_Group == "del" then local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
...
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال التوجيه هنا","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Fwd_Group == "ked" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
elseif Fwd_Group == "ktm" then
Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
elseif Fwd_Group == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
end print('This is forward') return false end 
--
if msg.reply_markup and msg.reply_markup.luatele == "replyMarkupInlineKeyboard" then -- الكيبورد
if not msg.Distinguished then local Keyboard_Group = Redis:get(SJaD.."SJaD:Lock:Keyboard"..msg_chat_id)
if Keyboard_Group == "del" then var(LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})) elseif Keyboard_Group == "ked" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0}) elseif Keyboard_Group == "ktm" then
Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg.chat_id,msg.sender.user_id)  elseif Keyboard_Group == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end end print('This is reply_markup') end 
--
if msg.content.location and not msg.Distinguished then  -- الموقع
if location then local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال المواقع ","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) end print('This is location') end 
--
...
local Markduan_Gtoup = Redis:get(SJaD.."SJaD:Lock:Markdaun"..msg_chat_id)
if Markduan_Gtoup == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) elseif Markduan_Gtoup == "ked" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0}) elseif Markduan_Gtoup == "ktm" then
Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg.chat_id,msg.sender.user_id)  elseif Markduan_Gtoup == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is textEntityTypeUrl') end 

if msg.content.game and not msg.Distinguished then  -- الالعاب
local Games_Group = Redis:get(SJaD.."SJaD:Lock:geam"..msg_chat_id)
if Games_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الالعاب","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is games') end 
--
if msg.content.luatele == "messagePinMessage" then -- رساله التثبيت
local Pin_Msg = Redis:get(SJaD.."SJaD:lockpin"..msg_chat_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n⤈︙لا استطيع الغاء تثبيت الرسائل ليست لديه صلاحيةه","md",true) end
return LuaTele.sendText(msg_chat_id,msg_id,"\n⤈︙التثبيت معطل من قبل المدراء","md",true) end print('This is message Pin') end 
--
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(SJaD.."SJaD:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) return false end end
--
if msg.content.luatele == "messageChatAddMembers" then -- اضافه اشخاص
print('This is Add Membeers ')
Redis:set(SJaD.."SJaD:Num:Add:Memp:gp"..msg_chat_id..":"..msg.content.member_user_ids[1],msg.sender.user_id) 
Redis:incr(SJaD.."SJaD:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(SJaD.."SJaD:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(SJaD.."SJaD:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(SJaD.."SJaD:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(SJaD.."SJaD:Lock:Contact"..msg_chat_id)
if Contact_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الجهات ","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is Contact') end 
--
if msg.content.luatele == "messageVideoNote" and not msg.Distinguished then  -- بصمه الفيديو
local Videonote_Group = Redis:get(SJaD.."SJaD:Lock:Unsupported"..msg_chat_id)
if Videonote_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال بصمات الفديو ","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is video Note') end 
--
if msg.content.luatele == "messageDocument" and not msg.Distinguished then  -- الملفات
local Document_Group = Redis:get(SJaD.."SJaD:Lock:Document"..msg_chat_id)
if Document_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الملفات ","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is Document') end 
--
if msg.content.luatele == "messageAudio" and not msg.Distinguished then  -- الملفات الصوتيه
local Audio_Group = Redis:get(SJaD.."SJaD:Lock:Audio"..msg_chat_id)
if Audio_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الصوتيات ","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
end print('This is Audio') end 
--
if msg.content.luatele == "messageVideo" and not msg.Distinguished then  -- الفيديو
local Video_Grouo = Redis:get(SJaD.."SJaD:Lock:Video"..msg_chat_id)
if Video_Grouo == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الفيديو","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is Video') end 
--
if msg.content.luatele == "messageVoiceNote" and not msg.Distinguished then  -- البصمات
local Voice_Group = Redis:get(SJaD.."SJaD:Lock:vico"..msg_chat_id)
if Voice_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال البصمات ","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is Voice') end 
--
if msg.content.luatele == "messageSticker" and not msg.Distinguished then  -- الملصقات
local Sticker_Group = Redis:get(SJaD.."SJaD:Lock:Sticker"..msg_chat_id)
if Sticker_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الملصقات","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is Sticker') end 
--
if msg.content.luatele == "messageUnsupported" and not msg.Distinguished then  -- الملصقات المتحركه
local StickerAn_Group = Redis:get(SJaD.."SJaD:Lock:StickerAn"..msg_chat_id)
if StickerAn_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الملصقات المتحركه","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif StickerAn_Group == "ked" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
elseif StickerAn_Group == "ktm" then
Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
elseif StickerAn_Group == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is Sticker') end 
--
if msg.via_bot_user_id ~= 0 and not msg.Distinguished then  -- انلاين
local Inlen_Group = Redis:get(SJaD.."SJaD:Lock:Inlen"..msg_chat_id)
if Inlen_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الانلاين ","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is viabot') end
--
if msg.content.luatele == "messageAnimation" and not msg.Distinguished then  -- المتحركات
local Gif_group = Redis:get(SJaD.."SJaD:Lock:Animation"..msg_chat_id)
if Gif_group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال المتحركات","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is Animation') end 
--
if msg.content.luatele == "messagePhoto" and not msg.Distinguished then  -- الصور
local Photo_Group = Redis:get(SJaD.."SJaD:Lock:Photo"..msg_chat_id)
if Photo_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الصور ","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0) end print('This is Photo delete') end
--
if msg.content.photo and Redis:get(SJaD.."SJaD:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(SJaD.."SJaD:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(SJaD.."SJaD:Lock:Link"..msg_chat_id)  
if not msg.Addictive then
if link_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الروابط هنا","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local UserName_Group = Redis:get(SJaD.."SJaD:Lock:User:Name"..msg_chat_id)
if UserName_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال المعرفات هنا","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(SJaD.."SJaD:Lock:hashtak"..msg_chat_id)
if Hashtak_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال التاك هنا","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(SJaD.."SJaD:Lock:Cmd"..msg_chat_id)
if comd_Group == "del" then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
if UserInfo.first_name then end
if UserInfo.username ~= "" then UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')' else UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserId..')' end
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عزيزي : "..UserInfousername.."\n⤈︙ممنوع ارسال الشارحه هنا","md",true)  
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
if (Redis:get(SJaD..'SJaD:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(SJaD.."SJaD:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(SJaD.."SJaD:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(SJaD.."SJaD:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(SJaD.."SJaD:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(SJaD.."SJaD:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(SJaD.."SJaD:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(SJaD.."SJaD:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(SJaD.."SJaD:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(SJaD..'SJaD:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n⤈︙ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(SJaD..'SJaD:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(SJaD.."SJaD:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(SJaD.."SJaD:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(SJaD.."SJaD:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(SJaD..'SJaD:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⤈︙تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(SJaD..'SJaD:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(SJaD.."SJaD:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(SJaD.."SJaD:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(SJaD.."SJaD:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(SJaD.."SJaD:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(SJaD.."SJaD:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(SJaD.."SJaD:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(SJaD.."SJaD:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(SJaD.."SJaD:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(SJaD..'SJaD:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(SJaD.."SJaD:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(SJaD.."SJaD:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(SJaD.."SJaD:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(SJaD.."SJaD:Command:List:Group"..msg_chat_id,text)
...
Redis:del(SJaD.."SJaD:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(SJaD.."SJaD:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(SJaD.."SJaD:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(SJaD.."SJaD:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(SJaD.."SJaD:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(SJaD.."SJaD:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(SJaD.."SJaD:Command:Reids:Group:New"..msg_chat_id)
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(SJaD.."SJaD:Command:List:Group"..msg_chat_id,text)
Redis:del(SJaD.."SJaD:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم حفظ الامر باسم ↫ { "..text..' }',"md",true)
end
if Redis:get(SJaD.."SJaD:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(SJaD.."SJaD:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(SJaD.."SJaD:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(SJaD.."SJaD:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(SJaD.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(SJaD.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(SJaD.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(SJaD.."SJaD:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(SJaD.."SJaD:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(SJaD.."SJaD:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(SJaD.."SJaD:Group:Rules" .. msg_chat_id,text) 
Redis:del(SJaD.."SJaD:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(SJaD.."SJaD:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(SJaD.."SJaD:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(SJaD.."SJaD:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(SJaD.."SJaD:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(SJaD.."SJaD:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم حفظ رد للمدير بنجاح \n⤈︙ارسل ( "..test.." ) لرؤية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(SJaD.."SJaD:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(SJaD.."SJaD:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(SJaD.."SJaD:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(SJaD.."SJaD:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(SJaD.."SJaD:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(SJaD.."SJaD:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(SJaD.."SJaD:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(SJaD.."SJaD:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(SJaD.."SJaD:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Video"..text)
local document = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:File"..text)
local audio = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(SJaD.."SJaD:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(SJaD..'SJaD:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(SJaD..'SJaD:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(SJaD.."SJaD:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(SJaD.."SJaD:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(SJaD.."SJaD:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(SJaD.."SJaD:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(SJaD.."SJaD:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(SJaD.."SJaD:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(SJaD.."SJaD:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(SJaD.."SJaD:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(SJaD.."SJaD:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(SJaD..'SJaD:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(SJaD.."SJaD:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(SJaD.."SJaD:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(SJaD.."SJaD:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(SJaD.."SJaD:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(SJaD.."SJaD:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(SJaD.."SJaD:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(SJaD.."SJaD:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(SJaD.."SJaD:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(SJaD.."SJaD:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(SJaD..'SJaD:'..v..text)
end
Redis:del(SJaD.."SJaD:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(SJaD.."SJaD:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(SJaD.."SJaD:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SJaD.."SJaD:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⤈︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(SJaD.."SJaD:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(SJaD.."SJaD:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(SJaD.."SJaD:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(SJaD.."SJaD:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(SJaD.."SJaD:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(SJaD.."SJaD:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(SJaD.."SJaD:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(SJaD.."SJaD:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(SJaD.."SJaD:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(SJaD.."SJaD:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SJaD.."SJaD:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SJaD.."SJaD:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⤈︙تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(SJaD..'SJaD:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SJaD.."SJaD:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SJaD.."SJaD:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⤈︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(SJaD.."SJaD:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SJaD.."SJaD:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SJaD.."SJaD:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SJaD.."SJaD:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SJaD.."SJaD:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(SJaD..'SJaD:GetTexting:DevSJaD'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر •' then 
Redis:del(SJaD..'SJaD:GetTexting:DevSJaD'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم الغاء حفظ كليشة المطور')
end
Redis:set(SJaD..'SJaD:Texting:DevSJaD',text)
Redis:del(SJaD..'SJaD:GetTexting:DevSJaD'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم حفظ كليشة المطور')
end
if Redis:get(SJaD.."SJaD:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⤈︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(SJaD.."SJaD:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(SJaD.."SJaD:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(SJaD.."SJaD:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(SJaD.."SJaD:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SJaD.."SJaD:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⤈︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(SJaD.."SJaD:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(SJaD.."SJaD:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⤈︙ تم تغير اسم البوت الى ↫ "..text,"md",true)    
end 
if Redis:get(SJaD.."SJaD:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SJaD.."SJaD:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⤈︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(SJaD.."SJaD:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(SJaD.."SJaD:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⤈︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(SJaD.."SJaD:Game:Smile"..msg.chat_id) then
if text == Redis:get(SJaD.."SJaD:Game:Smile"..msg.chat_id) then
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SJaD.."SJaD:Game:Smile"..msg.chat_id)
...
if Redis:get(SJaD.."SJaD:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(SJaD.."SJaD:Game:Monotonous"..msg.chat_id) then
Redis:del(SJaD.."SJaD:Game:Monotonous"..msg.chat_id)
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(SJaD.."SJaD:Game:Riddles"..msg.chat_id) then
if text == Redis:get(SJaD.."SJaD:Game:Riddles"..msg.chat_id) then
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SJaD.."SJaD:Game:Riddles"..msg.chat_id)
...
if Redis:get(SJaD.."SJaD:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(SJaD.."SJaD:Game:Meaningof"..msg.chat_id) then
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SJaD.."SJaD:Game:Meaningof"..msg.chat_id)
...
if Redis:get(SJaD.."SJaD:Game:Reflection"..msg.chat_id) then
if text == Redis:get(SJaD.."SJaD:Game:Reflection"..msg.chat_id) then
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SJaD.."SJaD:Game:Reflection"..msg.chat_id)
...
if Redis:get(SJaD.."SJaD:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(SJaD.."SJaD:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(SJaD.."SJaD:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(SJaD.."SJaD:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(SJaD.."SJaD:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(SJaD.."SJaD:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(SJaD.."SJaD:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(SJaD.."SJaD:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(SJaD.."SJaD:Game:Difference"..msg.chat_id) then
if text == Redis:get(SJaD.."SJaD:Game:Difference"..msg.chat_id) then 
Redis:del(SJaD.."SJaD:Game:Difference"..msg.chat_id)
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(SJaD.."SJaD:Game:Example"..msg.chat_id) then
if text == Redis:get(SJaD.."SJaD:Game:Example"..msg.chat_id) then 
Redis:del(SJaD.."SJaD:Game:Example"..msg.chat_id)
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if ChannelJoin(msg) == false and Redis:get(SJaD.."SJaD:Group:Join"..msg.chat_id) == nil  then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(SJaD..'SJaD:Group:Join:Name'..msg.chat_id)..'', url = 't.me/'..Redis:get(SJaD..'SJaD:Channel:Join')}, },}}
...
if tonumber(SJaD) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(SJaD..'SJaD:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(SJaD.."SJaD:ChekBotAdd",GroupId) 
if ListGroup.Posss then
for k,v in pairs(ListGroup.Posss) do
Redis:sadd(SJaD.."SJaD:TheMaleks:Group"..GroupId,v)
end
end
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(SJaD.."SJaD:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(SJaD.."SJaD:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(SJaD.."SJaD:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(SJaD.."SJaD:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(SJaD.."SJaD:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(SJaD) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(SJaD.."SJaD:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(SJaD.."SJaD:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(SJaD.."SJaD:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(SJaD.."SJaD:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(SJaD.."SJaD:TheBasics:Group"..idg,idASAS)
end;end
if v.MALK then
for k,idMALK in pairs(v.MALK) do
Redis:sadd(SJaD.."SJaD:TheMaleks:Group"..idg,idMALK)
end;end
end
...
if (Redis:get(SJaD..'SJaD:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⧾' then 
Redis:del(SJaD..'SJaD:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,SJaD).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⤈︙لم يتم تفعيل الاشتراك الاجباري\n⤈︙بسبب ان البوت ليس مشرفا بالقناة\n⤈︙يرجى رفع البوت مشرفا ثم تفعيل الاشتراك الاجباري مره اخرى","md",true)  
end
Redis:set(SJaD..'SJaD:Channel:Join',ChannelUser) 
Redis:set(SJaD..'SJaD:Channel:Join:Name',UserId_Info.title) 
...
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ↫'..Controller_Num(1)..'* ',"md",true)  
end
Redis:set(SJaD..'SJaD:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⤈︙ارسل لي الان معرف القناة\n⤈︙مثال على معرف القناة\n⤈︙@TI9TI9 ","md",true)
end
if text == 'تعطيل الاشتراك الاجباري •' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ↫'..Controller_Num(1)..'* ',"md",true)  
end
Redis:del(SJaD..'SJaD:Channel:Join')
...
os.execute('rm -rf SJaD.lua')
download('https://github.com/Yuosif6/SJaD/main/SJaD.lua','SJaD.lua')
...
local Groups = Redis:smembers(SJaD..'SJaD:ChekBotAdd')  
local UsersBot = Redis:smembers(SJaD..'SJaD:Num:User:Pv')  
local Get_Json = '{"BotId": '..SJaD..','  
if #UsersBot ~= 0 then 
...
local Posss = Redis:smembers(SJaD.."SJaD:TheMaleks:Group"..v)
local President = Redis:smembers(SJaD.."SJaD:TheBasics:Group"..v)
local Constructor = Redis:smembers(SJaD.."SJaD:Originators:Group"..v)
local Manager = Redis:smembers(SJaD.."SJaD:Managers:Group"..v)
local Admin = Redis:smembers(SJaD.."SJaD:Addictive:Group"..v)
local Vips = Redis:smembers(SJaD.."SJaD:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(SJaD.."SJaD:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(SJaD.."SJaD:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(SJaD.."SJaD:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(SJaD.."SJaD:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(SJaD.."SJaD:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(SJaD..'SJaD:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⤈︙عدد احصائيات البوت الكامله \n— — — — — — — — —\n⤈︙عدد المجموعات : '..(Redis:scard(SJaD..'SJaD:ChekBotAdd') or 0)..'\n⤈︙عدد المشتركين : '..(Redis:scard(SJaD..'SJaD:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(SJaD.."SJaD:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(SJaD..'SJaD:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(SJaD..'SJaD:Num:Add:Bot'),"md",true)  
end
...
{
{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›', url = 't.me/TI9TI9'},
},
}
}
if not msg.ControllerBot then
...
LuaTele.sendText(Sudo_Id,0,'*\n⤈︙↫ ⤈ تم تفعيل مجموعه جديده \n⤈︙بواسطة ↫ : {*['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')*} \n⤈︙معلومات المجموعه ↶\n⤈︙عدد الاعضاء ↫ '..Info_Chats.member_count..'\n⤈︙عدد الادمنيه ↫ '..Info_Chats.administrator_count..'\n⤈︙عدد المطرودين ↫ '..Info_Chats.banned_count..'\n︙عدد المقيدين ↫ '..Info_Chats.restricted_count..'*',"md",true, false, false, false, reply_markup)
end
Redis:sadd(SJaD.."SJaD:ChekBotAdd",msg_chat_id)
Redis:set(SJaD.."SJaD:Status:Id"..msg_chat_id,true) ;Redis:set(SJaD.."SJaD:Status:Reply"..msg_chat_id,true) ;Redis:set(SJaD.."SJaD:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(SJaD.."SJaD:Status:BanId"..msg_chat_id,true) ;Redis:set(SJaD.."SJaD:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(SJaD.."SJaD:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(SJaD.."SJaD:ChekBotAdd",msg_chat_id) then
...
Redis:srem(SJaD.."SJaD:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(SJaD.."SJaD:ChekBotAdd",msg_chat_id) then
Redis:incr(SJaD..'SJaD:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false and Redis:get(SJaD.."SJaD:Group:Join"..msg.chat_id) == nil  then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(SJaD..'SJaD:Channel:Join:Name')..'', url = 't.me/'..Redis:get(SJaD..'SJaD:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⤈︙عذرأ ، عليك الاشتراك في قناة البوت اولاً !*',"md",false, false, false, false, reply_markup)
end
if not Redis:get(SJaD.."SJaD:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(SJaD..'SJaD:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(SJaD..'SJaD:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(SJaD.."SJaD:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(SJaD.."SJaD:Set:Id:Group"..msg_chat_id)
if Redis:get(SJaD.."SJaD:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
-------------------------------------------------------------------------------------------
if text == 'بايو' and not Redis:get(SJaD..'idnotmembio'..msg.chat_id) then
...
if text == 'انا' or text == 'منو اني'  or text == 'اني' then
if not Redis:get(SJaD..'myName'..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"*⤈︙امر انا تم تعطيلة *","md",true)  
end
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local TotalPhoto = photo.total_count or 0
local RinkBot = msg.Name_Controller
...
{{text = '‹ انـت ›'..RinkBot..' ', url='https://t.me/TI9TI9'},},}
...
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙انت لا تمتلك صوره ..\nعليك وضع صوره الى حسابك اولاً',"md",true) 
end
end
if text == 'تحذير' or text == 'التحذير' then
if not Redis:get(SJaD..'Warning'..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"*⤈︙امر التحذير تم تعطيلة *","md",true)  
end

local UserInfo = LuaTele.getUser(msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'\n*تحذيࢪ 🔺️\n\nهذه المرة سماح ، ولكن في المرة الأخرى سوف يتم حظرك ، تجنب الكلمات المسيئه  ، لذلك الالتزام بالقوانين والتعليمات ونأمل أن تتحدث بكلمات ، أفضل في المرة القادمة  •\n\nتزحف طرد/ تدخل خاص تنطرد • تجاوز طرد\nمشكله احجيها هناا بالكروب انحلها لك •\nكلام مو حلو وغير للائق بالاعضاء طرد •*', "md")
end
if text == 'اسمي' then
if not Redis:get(SJaD..'ByNames'..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"*⤈︙امر اسمي تم تعطيلة *","md",true)  
end
...
if text == 'صورتي' and not Redis:get(SJaD..'myphoto'..msg.chat_id) then

local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local TotalPhoto = photo.total_count or 0
if photo.total_count > 0 then
local Texxt = '*⤈︙عدد صورك هوه ↫ '..TotalPhoto..'\n⤈︙وهذه الصوره رقم  ↫ 1 •\nيمكنك عرض صورك من خلال الزر . *'
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '‹ عࢪض الصور ›', callback_data=data.sender.user_id.."/ideengphoto"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(Texxt)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
else
...
local TotalMsg = Redis:get(SJaD..'SJaD:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(SJaD..'SJaD:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⤈︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(SJaD..'SJaD:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(SJaD..'SJaD:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⤈︙ايديه : '..UserId..
'\n⤈︙معرفه : @'..UserName..
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,SJaD).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,SJaD).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✓ ❭' else change_info = '❬ ✗ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(SJaD.."SJaD:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Developers:Groups",UserId) 
...
if not Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SJaD.."SJaD:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SJaD.."SJaD:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(SJaD.."SJaD:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SJaD.."SJaD:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SJaD.."SJaD:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(SJaD.."SJaD:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(SJaD.."SJaD:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(SJaD.."SJaD:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Developers:Groups",UserId) 
...
if Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SJaD.."SJaD:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SJaD.."SJaD:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⤈︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(SJaD.."SJaD:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(SJaD.."SJaD:Posss:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(SJaD.."SJaD:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(SJaD.."SJaD:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(SJaD.."SJaD:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(SJaD.."SJaD:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(SJaD.."SJaD:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(SJaD.."SJaD:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(SJaD.."SJaD:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⤈︙قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SJaD.."SJaD:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙لا يوجد منشئين اساسيين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(SJaD.."SJaD:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SJaD.."SJaD:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SJaD.."SJaD:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SJaD.."SJaD:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SJaD.."SJaD:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SJaD.."SJaD:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(SJaD.."SJaD:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(SJaD.."SJaD:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(SJaD.."SJaD:Status:Id"..msg_chat_id,true) 
...
Redis:set(SJaD.."SJaD:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(SJaD.."SJaD:Status:Reply"..msg_chat_id,true) 
...
Redis:set(SJaD.."SJaD:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(SJaD.."SJaD:Status:BanId"..msg_chat_id,true) 
...
Redis:set(SJaD.."SJaD:BotFree",true) 
...
Redis:set(SJaD.."SJaD:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(SJaD.."SJaD1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(SJaD.."SJaD1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(SJaD.."SJaD1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(SJaD..'SJaD1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(SJaD..'SJaD1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(SJaD..'SJaD1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(SJaD.."SJaD1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(SJaD.."SJaD1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(SJaD.."SJaD1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(SJaD.."SJaD1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(SJaD.."SJaD1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(SJaD.."SJaD1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(SJaD.."SJaD1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(SJaD.."SJaD1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(SJaD.."SJaD1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SJaD.."SJaD1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(SJaD.."SJaD1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SJaD.."SJaD1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(SJaD.."SJaD1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(SJaD.."SJaD1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SJaD.."SJaD1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(SJaD.."SJaD1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(SJaD.."SJaD1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(SJaD.."SJaD1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(SJaD.."SJaD11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(SJaD.."SJaD11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(SJaD.."SJaD11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(SJaD..'SJaD11:Add:Rd:Sudo:Text'..text)
Redis:del(SJaD..'SJaD11:Add:Rd:Sudo:Text1'..text)
Redis:del(SJaD..'SJaD11:Add:Rd:Sudo:Text2'..text)
Redis:del(SJaD.."SJaD11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(SJaD.."SJaD11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(SJaD.."SJaD11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(SJaD.."SJaD11:Add:Rd:Sudo:Text"..v) 
Redis:del(SJaD.."SJaD11:Add:Rd:Sudo:Text1"..v) 
Redis:del(SJaD.."SJaD11:Add:Rd:Sudo:Text2"..v)   
Redis:del(SJaD.."SJaD11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(SJaD.."SJaD11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(SJaD.."SJaD11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SJaD.."SJaD11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(SJaD.."SJaD11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SJaD.."SJaD11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(SJaD.."SJaD11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(SJaD.."SJaD11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SJaD.."SJaD11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(SJaD.."SJaD11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(SJaD.."SJaD11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(SJaD.."SJaD11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(SJaD.."SJaD:allM"..msg.chat_id, msg.id)
if Redis:get(SJaD.."SJaD:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(SJaD.."SJaD:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(SJaD.."SJaD:allM"..msg.chat_id)
...
Redis:del(SJaD.."SJaD:allM"..msg.chat_id)
end
end
end
if text == ("امسح") then  
...
local list = Redis:smembers(SJaD.."SJaD:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(SJaD.."SJaD:allM"..msg.chat_id)  
...
Redis:del(SJaD.."SJaD:Status:Del:Media"..msg.chat_id)
...
Redis:set(SJaD.."SJaD:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(SJaD.."SJaD:Status:yt"..msg.chat_id)
...
Redis:set(SJaD.."SJaD:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(SJaD.."SJaD:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(SJaD.."SJaD:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(SJaD.."SJaD:Status:Welcome"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Status:Id"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Status:Reply"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Status:BanId"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(SJaD.."SJaD:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(SJaD.."SJaD:Status:KickMe"..msg_chat_id) 
...
if not Redis:sismember(SJaD.."SJaD:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(SJaD.."SJaD:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(SJaD.."SJaD:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⤈︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(SJaD.."SJaD:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(SJaD.."SJaD:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⤈︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⤈︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(SJaD.."SJaD:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(SJaD.."SJaD:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(SJaD.."SJaD:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text == 'المبرمج' or text == 'مبرمج' or text == 'مبرمج سورس'  or text == 'مبرمج السورس'   or text == 'مطور السورس'  or text == 'مطور سورس' then  
if ChannelJoin(msg) == false and Redis:get(SJaD.."SJaD:Group:Join"..msg.chat_id) == nil  then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(SJaD..'SJaD:Channel:Join:Name')..'', url = 't.me/'..Redis:get(SJaD..'SJaD:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⤈︙عذرأ ، عليك الاشتراك في قناة البوت اولاً !*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat("WEIOD3")
...
if photo.total_count > 0 then
local TestText = "*⤈︙D𝐞𝐯 N𝐞𝐦𝐚 ↬ *["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*⤈︙D𝐞𝐯 I𝐝 ↬ *["..UserInfo.id.."](tg://user?id="..UserInfo.id..")\n*⤈︙U𝐬𝐞𝐫 N𝐚𝐦𝐞 ↬* "..UserInfousername.."\n*⤈︙D𝐞𝐯 B𝐢𝐨 ↬* ["..Bio.."]\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉•"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ''..UserInfo.first_name..'', url='tg://user?id='..UserId_Info.id},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
else
local TestText = "\n*⤈︙D𝐞𝐯 N𝐞𝐦𝐚 ↬ *["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*⤈︙D𝐞𝐯 I𝐝 ↬ *["..UserInfo.id.."](tg://user?id="..UserInfo.id..")\n*⤈︙U𝐬𝐞𝐫 N𝐚𝐦𝐞 ↬* "..UserInfousername.."\n*⤈︙D𝐞𝐯 B𝐢𝐨 ↬* ["..Bio.."]\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉•"
keyboardd = {} 
keyboardd.inline_keyboard = {
{ 
{text = ''..UserInfo.first_name..'', url='tg://user?id='..UserId_Info.id},
...
if photo.total_count > 0 then
local TestText = "* ⤈︙D𝐞𝐯 N𝐞𝐦𝐚 ↬* ["..UserInfo.first_name.."](tg://user?id="..Sudo_Id..")\n*⤈︙D𝐞𝐯 I𝐝 ↬* ["..UserInfo.id.."](tg://user?id="..UserInfo.id..")\n*⤈︙D𝐞𝐯 B𝐢𝐨 ↬* ["..Bio.."]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
...
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*•￤عذرآ البوت ليس مشرف في المجموعه يرجى ترقيته وتفعيل الصلاحيات له*","md",true)  
end
local Info_Members = LuaTele.getSupergroupMembers(msg_chat_id, "Administrators", "*", 0, 200)
local List_Members = Info_Members.members
for k, v in pairs(List_Members) do
...
if photo.total_count > 0 then
local TestText = "*⤈︙Owner Name ↬*["..UserInfo.first_name.."](tg://user?id="..UserInfo.id..")\n*⤈︙Owner id ↬*["..UserInfo.id.."](tg://user?id="..UserInfo.id..")\n*⤈︙Owner Name ↬ * "..UserInfousername.."\n*⤈︙Owner Bio ↬*"..Bio.."\n•┉• ┉ ┉ ┉ ┉ ┉ ┉• ┉•"
local msg_id = msg.id/2097152/0.5 
keyboardd = {} 
keyboardd.inline_keyboard = {
{
...
Redis:set(SJaD.."SJaD:Lock:text"..msg_chat_id,true) 
...
Redis:set(SJaD.."SJaD:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(SJaD.."SJaD:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(SJaD.."SJaD:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(SJaD.."SJaD:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(SJaD.."SJaD:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(SJaD.."SJaD:Lock:edit"..msg_chat_id,true) 
...
Redis:set(SJaD.."SJaD:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(SJaD..'SJaD:'..lock..msg_chat_id,"del")    
end
...
Redis:del(SJaD.."SJaD:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(SJaD.."SJaD:Lock:text"..msg_chat_id)  
...
Redis:del(SJaD.."SJaD:Lock:Join"..msg_chat_id)  
...
Redis:del(SJaD.."SJaD:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(SJaD.."SJaD:Lock:tagservr"..msg_chat_id)  
...
Redis:del(SJaD.."SJaD:lockpin"..msg_chat_id)  
...
Redis:del(SJaD.."SJaD:Lock:edit"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(SJaD..'SJaD:'..lock..msg_chat_id)    
end
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⤈︙تم فـتح جميع الاوامر").unLock,"md",true)  
return false
end 

if text == "قفل القناه"  or text == "قفل القناة"  or text == "قفل ارسال القناة"  or text == "قفل ارسال القناه"   then 
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ⇝'..Controller_Num(7)..'* ',"md",true)  
end
Redis:set(SJaD.."SJaD:Lock:Channel"..msg_chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⤈︙تم قفـل القناة").Lock,"md",true)  
return false
end 
if text == "فتح القناه"  or text == "فتح القناة"  or text == "فتح ارسال القناة"  or text == "فتح ارسال القناه"  then 
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ⇝'..Controller_Num(7)..'* ',"md",true)  
end
Redis:del(SJaD.."SJaD:Lock:Channel"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⤈︙تم فتح القناة").unLock,"md",true)  
return false
end 
...
Redis:set(SJaD.."SJaD:Lock:phshar"..msg_chat_id,true) 
...
Redis:del(SJaD.."SJaD:Lock:phshar"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⤈︙تم فتح الفشار").unLock,"md",true)  
return false
end 

if (Redis:get(SJaD.."SJaD:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(SJaD.."SJaD:AddSudosNew"..msg_chat_id)
...
data = {
{
{text = 'نعم متاكد', data = msg.sender.user_id..'/chsudoy@'..UserId_Info.id},{text = 'الغاء التحويل', data = msg.sender.user_id..'/chsudon'},
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id, '⤈︙اختر لاكمال العمليه', 'md', false, false, false, false, reply_markup)
end
end
...
Redis:set(SJaD.."SJaD:AddSudosNew"..msg_chat_id,true)
...
if not Redis:get(SJaD.."knele"..msg.chat_id) then
Abs = math.random(2,140); 
local Text ='*⤈︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '‹ مࢪه اخࢪى ›', callback_data = IdUser..'/Music@'},},
{{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›',url="t.me/TI9TI9"}}} 
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/PFFFPFF/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
if text == "حالات" or text == "حالات واتس" then
if not Redis:get(SJaD.."knele"..msg.chat_id) then
Abs = math.random(296,400); 
local Text ='*⤈︙تم اختيار حالات واتس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›',url="t.me/TI9TI9"}}} 
local msg_id = msg.id/2097152/0.5 
...
local Text ='*⤈︙تم اختيار ستوري انمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›',url="t.me/TI9TI9"}}} 
local msg_id = msg.id/2097152/0.5 
...
local Text ='*⤈︙تم اختيار افتار انمي بنت لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
...
local Text ='*⤈︙تم اختيار افتار انمي ولد لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
...
local Text ='*⤈︙تم اختيار افتار ولـد لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
...
local Text ='*⤈︙تم اختيار افتار تطقيم بنات لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
...
local Text ='*⤈︙تم اختيار افتار تطقيم حب لك*'
local MsgId = msg.id/2097152/0.5
local MSGID = string.gsub(MsgId,'.0','')
...
local Text ='*⤈︙تم اختيار المقطع ريمكس لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›',url="t.me/TI9TI9"}}} 
local msg_id = msg.id/2097152/0.5 
...
local Text ='*⤈︙تم اختيار مقطـع الرقيـة الشرعية لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›',url="t.me/TI9TI9"}}} 
local msg_id = msg.id/2097152/0.5 
...
Redis:hset(SJaD.."SJaD:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(SJaD.."SJaD:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(SJaD.."SJaD:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(SJaD.."SJaD:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(SJaD.."SJaD:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(SJaD.."SJaD:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Link"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:User:Name"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:hashtak"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Cmd"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Photo"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Video"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Animation"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:geam"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Audio"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:vico"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Sticker"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:forward"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Document"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Contact"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Spam"..msg_chat_id)  
...
Redis:set(SJaD.."SJaD:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(SJaD.."SJaD:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(SJaD.."SJaD:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(SJaD.."SJaD:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(SJaD.."SJaD:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(SJaD.."SJaD:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(SJaD.."SJaD:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(SJaD.."SJaD:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(SJaD.."SJaD:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(SJaD.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(SJaD.."SJaD:Status:Welcome"..msg_chat_id) then
...
Redis:del(SJaD.."SJaD:Welcome:Group"..msg_chat_id) 
...
Redis:setex(SJaD.."SJaD:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(SJaD.."SJaD:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(SJaD.."SJaD:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(SJaD.."SJaD:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(SJaD.."SJaD:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(SJaD.."SJaD:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(SJaD.."SJaD:Filter:Group:"..v..msg_chat_id)  
Redis:srem(SJaD.."SJaD:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(SJaD.."SJaD:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(SJaD..'SJaD:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(SJaD..'SJaD:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(SJaD.."SJaD:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(SJaD.."SJaD:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(SJaD.."SJaD:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(SJaD.."SJaD:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(SJaD.."SJaD:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✓ ❭' else Statuslink = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✓ ❭' else StatusWelcome = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:Id"..msg.chat_id) then
StatusId = '❬ ✓ ❭' else StatusId = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✓ ❭' else StatusIdPhoto = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✓ ❭' else StatusReply = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✓ ❭' else StatusReplySudo = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✓ ❭' else StatusBanId = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✓ ❭' else StatusSetId = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✓ ❭' else StatusGames = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✓ ❭' else Statuskickme = '❬ ✗ ❭'
end
if Redis:get(SJaD.."SJaD:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(SJaD.."SJaD:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(SJaD.."SJaD:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(SJaD.."SJaD:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
else
Rink = 9
end
...
Rink = 1
elseif Redis:sismember(SJaD.."SJaD:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(SJaD.."SJaD:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(SJaD.."SJaD:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(SJaD.."SJaD:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(SJaD.."SJaD:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
elseif Redis:sismember(SJaD.."SJaD:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 8
else
Rink = 9
end
...
Redis:del(SJaD..'SJaD:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
...
Redis:del(SJaD..'SJaD:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
...
Redis:del(SJaD..'SJaD:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
...
LuaTele.sendText(msg_chat_id,msg_id,'⤈︙عدد رسائلك هنا *~ '..(Redis:get(SJaD..'SJaD:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
if ChannelJoin(msg) == false and Redis:get(SJaD.."SJaD:Group:Join"..msg.chat_id) == nil  then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(SJaD..'SJaD:Channel:Join:Name')..'', url = 't.me/'..Redis:get(SJaD..'SJaD:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⤈︙عذرأ ، عليك الاشتراك في قناة البوت اولاً !*',"md",false, false, false, false, reply_markup)
end
LuaTele.sendText(msg_chat_id,msg_id,'⤈︙عدد التعديلات هنا *~ '..(Redis:get(SJaD..'SJaD:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
if ChannelJoin(msg) == false and Redis:get(SJaD.."SJaD:Group:Join"..msg.chat_id) == nil  then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(SJaD..'SJaD:Channel:Join:Name')..'', url = 't.me/'..Redis:get(SJaD..'SJaD:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⤈︙عذرأ ، عليك الاشتراك في قناة البوت اولاً !*',"md",false, false, false, false, reply_markup)
end
LuaTele.sendText(msg_chat_id,msg_id,'⤈︙عدد جهاتك المضافه هنا *~ '..(Redis:get(SJaD.."SJaD:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
if text == "تعطيل البايو" or text == "تعطيل بايو" then

if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ⇝'..Controller_Num(6)..'* ',"md",true)  
end
if Redis:get(SJaD..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '⤈︙تم تعطيل امر البايو مسبقا',"md")
else
Redis:set(SJaD.."idnotmembio"..msg.chat_id,"true")
LuaTele.sendText(msg_chat_id,msg_id, '⤈︙تم تعطيل امر البايو ',"md")
end
end
if text == "تفعيل البايو" or text == "تفعيل بايو" then

if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ⇝'..Controller_Num(6)..'* ',"md",true)  
end
if not Redis:get(SJaD..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '⤈︙تم تفعيل امر البايو مسبقا\n ',"md")
else
Redis:del(SJaD.."idnotmembio"..msg.chat_id)
LuaTele.sendText(msg_chat_id,msg_id, '⤈︙تم تفعيل امر البايو \n',"md")
end
end


if text == "تفعيل التحذير"  or text == 'تفعيل تحذير'  then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ⇝'..Controller_Num(7)..'* ',"md",true)  
end
if Redis:get(SJaD..'Warning'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تفعيل التحذير مسبقا\n ',"md")
else
Redis:set(SJaD.."Warning"..msg.chat_id,"true")
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تفعيل امر التحذير\n ',"md")
end
end
...
if not Redis:get(SJaD..'Warning'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تعطيل التحذير مسبقا\n ',"md")
else
Redis:del(SJaD.."Warning"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تعطيل امر التحذيز\n ',"md")
end
end
...
if Redis:get(SJaD..'ByNames'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تفعيل اسمي مسبقا\n ',"md")
else
Redis:set(SJaD.."ByNames"..msg.chat_id,"true")
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تفعيل امر اسمي\n ',"md")
end
end
...
if not Redis:get(SJaD..'ByNames'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تعطيل اسمي مسبقا\n ',"md")
else
Redis:del(SJaD.."ByNames"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تعطيل امر اسمي\n ',"md")
end
end
if text == "تفعيل انا" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ⇝'..Controller_Num(7)..'* ',"md",true)  
end
if Redis:get(SJaD..'myName'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تفعيل انا مسبقا\n ',"md")
else
Redis:set(SJaD.."myName"..msg.chat_id,"true")
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تفعيل امر انا\n ',"md")
end
end
if text == "تعطيل انا" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⤈︙هذا الأمر يخص ⇝'..Controller_Num(7)..'* ',"md",true)  
end
if not Redis:get(SJaD..'myName'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تعطيل انا مسبقا\n ',"md")
else
Redis:del(SJaD.."myName"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙تم تعطيل امر انا\n ',"md")
end
end
...
Redis:setex(SJaD.."SJaD:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⤈︙ارسل الان النص
⤈︙يمكنك اضافه :
...
Redis:del(SJaD.."SJaD:Set:Id:Group"..msg.chat_id)
...
Redis:del(SJaD.."SJaD:DevelopersQ:Groups") 
...
Redis:del(SJaD.."SJaD:Developers:Groups") 
...
Redis:del(SJaD.."SJaD:TheMaleks:Group"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:TheBasics:Group"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Originators:Group"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Managers:Group"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Addictive:Group"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:Distinguished:Group"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:BanAll:Groups") 
...
Redis:del(SJaD.."SJaD:BanGroup:Group"..msg_chat_id) 
...
Redis:del(SJaD.."SJaD:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(SJaD.."SJaD:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(SJaD.."SJaD:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(SJaD.."SJaD:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(SJaD.."SJaD:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف •"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(SJaD.."SJaD:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(SJaD.."SJaD:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(SJaD.."SJaD:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:Gif"..v)   
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:vico"..v)   
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:stekr"..v)     
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:Text"..v)   
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:Photo"..v)
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:Video"..v)
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:File"..v)
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:Audio"..v)
Redis:del(SJaD.."SJaD:Add:Rd:Sudo:video_note"..v)
Redis:del(SJaD.."SJaD:List:Rd:Sudo")
end
...
text = "\n⤈︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Sudo:File"..v) then
db = "ملف •"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(SJaD.."SJaD:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(SJaD.."SJaD:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(SJaD.."SJaD:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(SJaD.."SJaD:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(SJaD.."SJaD:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(SJaD.."SJaD:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(SJaD.."SJaD:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(SJaD.."SJaD:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(SJaD..'SJaD:GetTexting:DevSJaD'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(SJaD..'SJaD:Texting:DevSJaD')
...
photo = "https://t.me/xgdyihbnvkbbb/2"
local T =[[
[⤈︙𝖲𝗈𝗎𝗋𝖼𝖾 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱](t.me/TI9TI9)                                    
⤈︙𝖶𝖾l𝖼𝗈𝗆𝖾 𝗍𝗈 𝖲𝗈𝗎𝗋𝖼𝖾 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱                   
‹ ━━━━━━ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ━━━━━━ ›
]]
keyboard = {} 
...
{
{text = '‹ Developer •', url = "https://t.me/WEIOD3"},{text = ' • Exp Source ›', url = "https://t.me/TI9TI9"}
},
{
},
{
{text = ' ‹ Files Channel •', url = "https://t.me/TTI9TT"},{text =' • Tws BoT ›' , url = "https://t.me/P5P5bot"}
},
}
...
data = {
{
{text = '‹ 𝟏 ›', data = msg.sender.user_id..'/help1'},{text = '‹ 𝟐 ›', data = msg.sender.user_id..'/help2'},{text = '‹ 𝟑 ›', data = msg.sender.user_id..'/help3'},{text = '‹ 𝟒 ›', data = msg.sender.user_id..'/help4'},
},
{
{text = '‹ 𝟓 ›', data = msg.sender.user_id..'/help5'},{text = '‹ 𝟔 ›', data = msg.sender.user_id..'/NoNextSeting'},{text = '‹ 𝟕 ›', data = msg.sender.user_id..'/listallAddorrem'},{text = '‹ 𝟖 ›', data = msg.sender.user_id..'/help6'},
},
{
{text = '• اوامر الاعضاء •', data = msg.sender.user_id..'/help7'},},
{
{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›', url = 't.me/TI9TI9'},
},
}
...
⤈︙ م6 •  ↫  اۅامـر الـقفـل & الفتـح
⤈︙ م7 •  ↫  اۅامـر الـتعطيل & التفعيل
⤈︙ م8 •  ↫  اۅامـر الـخدمـات الالعـاب
• — — — — — — — — — •
⤈︙𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 : @TI9TI9 ›
...
data = {
{
{text = '• الاوامࢪ •', data = msg.sender.user_id..'/helpall'},
},
{
{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›', url = 't.me/TI9TI9'}, 
},
...
{
{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›', url = 'https://t.me/TI9TI9'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'⤈︙عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
...
Redis:setex(SJaD.."SJaD:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(SJaD.."SJaD:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⤈︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(SJaD.."SJaD:Name:Bot") or "فولتر") then
local NamesBot = (Redis:get(SJaD.."SJaD:Name:Bot") or "فولتر")
local NameBots = {
"ڪول • حبيبي اﻧـييہ"..NamesBot.. "❤️‍🔥",
"أჂ̤ أჂ̤ هياتنيہ يـمكہ",
"هلاآ ؏ـمـريـہ . وياڪك",
"بعـد روحيہ احمد قاسم",
"بۅت بـ؏ـينكہ 😒"..NamesBot,
'عنديہ آسم تࢪه ؟'
}
...
local NamesBot = (Redis:get(SJaD.."SJaD:Name:Bot") or "فولتر")
local BotName = {
"لتڪول بۅٛت اسَميہ"..NamesBot,
"شتࢪيَد ضَݪـ؏ـييہ 🙂 "..NamesBot.. "",
"عنديہ آسم تࢪه 🥲"
}
...
x = x + 1
Redis:srem(SJaD..'SJaD:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,SJaD)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⤈︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(SJaD..'SJaD:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(SJaD..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(SJaD..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(SJaD..'SJaD:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(SJaD.."SJaD:Game:Smile"..msg.chat_id,SM)
...
" لو بكيفي كان ؟ ", 
  ...
  "اسم قريب لقلبك؟ ",
  "إذكر الصفات التي تكرها في نفسك؟ ",
...
Redis:set(SJaD.."SJaD:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(SJaD.."SJaD:Game:Riddles"..msg.chat_id,name)
...
if Redis:get(SJaD.."SJaD:Status:Games"..msg.chat_id) then
Redis:del(SJaD.."SJaD:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(SJaD.."SJaD:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(SJaD.."SJaD:Status:Games"..msg.chat_id) then
Redis:del(SJaD.."SJaD:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(SJaD.."SJaD:Game:Reflection"..msg.chat_id,name)
...
Redis:set(SJaD.."SJaD:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(SJaD.."SJaD:Game:Difference"..msg.chat_id,name)
...
Redis:set(SJaD.."SJaD:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(SJaD.."SJaD:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(SJaD.."SJaD:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(SJaD.."SJaD:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(SJaD.."SJaD:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:sadd(SJaD..'SJaD:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(SJaD.."SJaD:Start:Bot") then
local CmdStart = '*\n⤈︙أهلآ بك في بوت '..(Redis:get(SJaD.."SJaD:Name:Bot") or "فولتر")..
...
{
{text = '• المطور .', url = 't.me/'..UserSudo},{text = '• شراء بوت .', url = 't.me/P5P5bot'}, 
},
{
{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›', url = 'https://t.me/TI9TI9'},},
}
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(SJaD.."SJaD:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
{
{text = 'قناة الاشتراك •',type = 'text'},{text = 'تغيير الاشتراك الاجباري •',type = 'text'},
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n⤈︙مرحبا عزيزي ↫ المطوࢪ \n⤈︙انت ‹ المطوࢪ الاساسي › هنا \n⤈︙اليك ازࢪار سوࢪس فولتر\n⤈︙تستطيع التحكم بكل الاوامࢪ فقط اضغط على الامࢪ الذي تريد تنفيذه ↶', 'md', false, false, false, false, reply_markup)
end
end
...
Redis:setex(SJaD.."SJaD:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(SJaD.."SJaD:TwaslBot") and not Redis:sismember(SJaD.."SJaD:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(SJaD.."SJaD:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(SJaD.."SJaD:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(SJaD..'SJaD:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⤈︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(SJaD..'SJaD:BaN:In:Tuasl',Info_User)  
...
Redis:srem(SJaD.."SJaD:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(SJaD..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(SJaD.."SJaD:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SJaD.."SJaD:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(SJaD.."SJaD:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == SJaD then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(SJaD..'SJaD:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(SJaD.."SJaD:Lock:edit"..data.chat_id) then
...
return LuaTele.editMessageText(ChatId,Msg_id,'*⤈︙عليك اختيار احدى الصيغ للتنزيل *', 'md', true, false, reply_markup)
end
end
...
Redis:incrby(SJaD.."SJaD:Num:Add:Games"..ChatId..IdUser, 1)  
...
data = {
{
{text = '‹ 𝟏 ›', data = IdUser..'/help1'},{text = '‹ 𝟐 ›', data = IdUser..'/help2'},{text = '‹ 𝟑 ›', data = IdUser..'/help3'},{text = '‹ 𝟒 ›', data = IdUser..'/help4'},
},
{
{text = '‹ 𝟓 ›', data = IdUser..'/help5'},{text = '‹ 𝟔 ›', data = IdUser..'/NoNextSeting'},{text = '‹ 𝟕 ›', data = IdUser..'/listallAddorrem'},{text = '‹ 𝟖 ›', data = IdUser..'/help6'},
},
{
...
if Text and Text:match('(%d+)/help7') then
...
⤈︙اوامر الاعضاء ↫ ⤈
ٴ┉┉┉┉┉┉┉┉┉┉┉ٴ
• السورس • يا سورس • سورس • معلوماتي •
• موقعي • انا • اني • صلاحياتي • غنيلي
• شعر • متحركه • صوره • ريمكس • فلم • انمي • 
• رسائلي • حذف رسائلي • اسمي • معرفي •
• ايدي • ايديي • جهاتي • سحكاتي • صورتي •
• مجوهراتي • بيع مجوهراتي • القوانين • المالك 
• المنشئ • المبرمج • مطور السورس • المطور 
• الرابط •
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⤈︙اوامر الترفيه ↫ ⤈
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
• • ريمكس ↫ ࢪيمكسات اغـاني 
⤈︙ ميمز ↫ ميمـز بصمـات
• • شعر ↫ اشعـاࢪ صۅتيـة
• • رقيه ↫ ࢪقيـة شࢪعيـة
• • حالات ↫ حـالات واتس قصيࢪة
• • ستوري ↫ ستۅࢪيات مقاطع انمي
• • فلم ↫ عـࢪۅض الافـلام
• • غنيلي ↫ فۅيس اغـاني قصيـࢪة
• • انمي ↫ صـوࢪ انمي عشۅائي
• • انمي ولد ↫ صوࢪ ۅلـد انمي
• • انمي بنت ↫ صـوࢪ بنـات انمي
• • صوره ↫ صـوࢪ عشۅائـي
⤈︙ متحركه ↫ متحـࢪكـات عشۅائـي
• • افتار بنت ↫افتـاࢪات بنـات تمبلـࢪ
• • رمادي بنت ↫ افتـاࢪات بنات ࢪماديه
• • رمادي ولد ↫ افتـارات ۅلـد رمـاديه
• • بيست بنت ↫ افتـاࢪات بيست بنـات
• • تطقيم حب ↫ افتـاࢪات تطقيم حـب
ٴ┉┉┉┉┉┉┉┉┉┉┉ٴ
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
{
{text = '• اوامر الاعضاء •', data = IdUser..'/help'},
},
{
{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›', url = 't.me/TI9TI9'},
},
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Link"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⤈︙تم قفـل الروابط").Lock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/lock_spam') then
local UserId = Text:match('(%d+)/lock_spam')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(SJaD.."SJaD:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(SJaD.."SJaD:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(SJaD.."SJaD:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(SJaD.."SJaD:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:Link"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SJaD.."SJaD:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(SJaD.."SJaD:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(SJaD.."SJaD:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(SJaD.."SJaD:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(SJaD..'SJaD:'..lock..UserId[2],"del")    
end
...
if Text and Text:match('(%d+)/backphoto') then
local UserId = Text:match('(%d+)/backphoto')
if tonumber(IdUser) == tonumber(UserId) then
local photo = LuaTele.getUserProfilePhotos(UserId)
local TotalPhoto = photo.total_count or 0
if photo.total_count > 0 then
local msg_id = data.message_id/2097152/0.5 
local keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مره اخࢪى •', callback_data=IdUser.."/ideengphoto"},
},} 
media = {
type = 'photo',
media = photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,
caption = '⤈︙عدد صورك هوه ↫ '..TotalPhoto..'\n⤈︙وهذه الصوره رقم  ↫ 1 •'
}
return https.request("https://api.telegram.org/bot"..Token.."/editMessageMedia?chat_id="..data.chat_id.."&message_id="..msg_id.."&media="..JSON.encode(media).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..URL.escape(JSON.encode(keyboard)))
end
end
elseif Text and Text:match('(%d+)/ideengphoto') then
local UserId = Text:match('(%d+)/ideengphoto')
if tonumber(IdUser) == tonumber(UserId) then
local photo = LuaTele.getUserProfilePhotos(UserId)
local TotalPhoto = photo.total_count or 0
if photo.total_count > 0 then
...
local keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• التالية •', callback_data=IdUser.."/ideen"},{text = '• السابقة •', callback_data=IdUser.."/backphoto"}},
{{text = '• اخفاء الامر •', callback_data=IdUser.."/delAmr"}},} 
media1 = {type = 'photo',media = photo.photos[2].sizes[#photo.photos[2].sizes].photo.remote.id,
caption = '⤈︙عدد صورك هوه ↫ '..TotalPhoto..'\n⤈︙وهذه الصوره رقم  ↫ 2 •'}
return https.request("https://api.telegram.org/bot"..Token.."/editMessageMedia?chat_id="..data.chat_id.."&message_id="..msg_id.."&media="..JSON.encode(media1).."&reply_markup="..URL.escape(JSON.encode(keyboard)))
end
end
elseif Text and Text:match('(%d+)/ideen') then
local UserId = Text:match('(%d+)/ideen')
if tonumber(IdUser) == tonumber(UserId) then
local photo = LuaTele.getUserProfilePhotos(UserId)
local TotalPhoto = photo.total_count or 0
if photo.total_count > 0 then
...
local keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• التالية •', callback_data=IdUser.."/Hjj"},{text = '• السابقة •', callback_data=IdUser.."/ideengphoto"}},
{{text = '• اخفاء الامر •', callback_data=IdUser.."/delAmr"}},} 
media2 = {type = 'photo',media = photo.photos[3].sizes[#photo.photos[3].sizes].photo.remote.id,
caption = '⤈︙عدد صورك هوه ↫'..TotalPhoto..'\n⤈︙وهذه الصوره رقم  ↫ 3 •'}
return https.request("https://api.telegram.org/bot"..Token.."/editMessageMedia?chat_id="..data.chat_id.."&message_id="..msg_id.."&media="..JSON.encode(media2).."&reply_markup="..URL.escape(JSON.encode(keyboard)))
end
end
elseif Text and Text:match('(%d+)/Hjj') then
local UserId = Text:match('(%d+)/Hjj')
if tonumber(IdUser) == tonumber(UserId) then
local photo = LuaTele.getUserProfilePhotos(UserId)
local TotalPhoto = photo.total_count or 0
if photo.total_count > 0 then
...
local keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• التاالية •', callback_data=IdUser.."/Photos"},{text = '• السابقة •', callback_data=IdUser.."/ideen"}},
{{text = '• اخفاء الامر •', callback_data=IdUser.."/delAmr"}},} 
media3 = {type = 'photo',media = photo.photos[4].sizes[#photo.photos[4].sizes].photo.remote.id,
caption = '⤈︙عدد صورك هوه ↫ '..TotalPhoto..'\n⤈︙وهذه الصوره رقم  ↫ 4 •'}
return https.request("https://api.telegram.org/bot"..Token.."/editMessageMedia?chat_id="..data.chat_id.."&message_id="..msg_id.."&media="..JSON.encode(media3).."&reply_markup="..URL.escape(JSON.encode(keyboard)))
end
end
...
local keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• تراجع •', callback_data=IdUser.."/Hjj"}},} 
media4 = {type = 'photo',media = photo.photos[5].sizes[#photo.photos[5].sizes].photo.remote.id,
caption = '⤈︙عدد صورك هوه ↫ '..TotalPhoto..'\n⤈︙وهذه الصوره رقم  ↫ 5 •'}
return https.request("https://api.telegram.org/bot"..Token.."/editMessageMedia?chat_id="..data.chat_id.."&message_id="..msg_id.."&media="..JSON.encode(media4).."&reply_markup="..URL.escape(JSON.encode(keyboard)))
end
end
end

if Text and Text:match('(%d+)/chsudoy@(%d+)') then
local UserId = {Text:match('(%d+)/chsudoy@(%d+)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
local UserInfo = LuaTele.getUser(UserId[2])
local Informationlua = io.open("Information.lua", 'w')
Informationlua:write([[
...
Token = "]]..Token..[[",
UserBot = "]]..UserBot..[[",
UserSudo = "]]..UserInfo.username:gsub('@','')..[[",
SudoId = ]]..UserId[2]..[[
}
]])
Informationlua:close()
LuaTele.editMessageText(ChatId,Msg_id,"\n⤈︙تم تغيير المطور الاساسي اصبح على ⇝ [@"..UserInfo.username:gsub('@','').."]", 'md')
dofile('SJaD.lua')  
end
end
if Text and Text:match('(%d+)/chsudon') then
local UserId = Text:match('(%d+)/chsudon')
if tonumber(IdUser) == tonumber(UserId) then
return LuaTele.editMessageText(ChatId,Msg_id,"\n⤈︙تم الغاء عمليه التحويل", 'md')
end
end
...
keyboard.inline_keyboard = {{{text = '‹ مࢪه اخࢪى ›', callback_data = IdUser..'/Music@'},},
{{text = '‹ 𝖲𝗈𝖴𝗋𝖼𝖾 𝖵𝗈𝖫𝖳𝖾𝖱 ›',url="t.me/TI9TI9"}}} 
local url , res = https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..ChatId.."&audio=https://t.me/PFFFPFF/"..math.random(2,140).."&caption="..URL.escape('*⤈︙تم اختيار الاغنيه لك تلقائياً*').."&parse_mode=Markdown&reply_to_message_id="..msg_id.."&reply_markup="..URL.escape(JSON.encode(keyboard)))
local Json_Info = JSON.decode(url)
print(Json_Info.ok) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
...
data = {
{
{text = GetSetieng(ChatId).lock_fwd, data = '&'},{text = '• التوجيه •', data =IdUser..'/'.. 'Status_fwd'},
},
{
...
{
{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},
},
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(SJaD.."SJaD:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجۅع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:TheMaleks:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:Distinguished:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⤈︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SJaD.."SJaD:SilentGroup:Group"..ChatId) 
